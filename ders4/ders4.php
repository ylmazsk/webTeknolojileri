...
<h3>Php'de Diziler</h3>
    ...
    echo "Sayıları Dizinisinin İçerisindeki 2. Dizinin 3. Elemanı:" . $sayilar[1][2];
    

    echo "<br>Sayıları Dizinisinin İçerisindeki 1. Dizinin 4 İndisli Elemanı:" . $sayilar[0][4];

    echo "<br>--------";
    $sayilar = array (
        "integer" => array(55, 23, 15, 24),
        "double" => array(13.5, 2.5, 1.35)
    );
    echo "<pre>";
    print_r($sayilar);
    echo "</pre>";
    
    echo "Sayılar Dizininsinin İçersindeki 1. Dizinin 2 İndisli Elemanı: " .  $sayilar["integer"][1];

    echo "<br>Sayılar Dizinisinin İçersindeki 2. Dizinin 2 İndisli Elemanı: " . $sayilar["double"][2];
    ...
    echo "$bilgiler[adi] $bilgiler[soyadi] hoşgeldimiz.";
